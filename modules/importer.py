...
class Importer:
    ...
    def _normalize_columns(self, df):
        ...
        # MODIFIED: Added 'resume' and 'role' as aliases for normalization.
        rename_map = {
    ...
    def import_from_resume(self, resume_url):
        # MODIFIED: Refactored to use the helper processing function.
